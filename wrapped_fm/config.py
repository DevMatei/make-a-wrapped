...
API_RENDER_CONCURRENCY = max(1, int(os.getenv("APP_API_RENDER_CONCURRENCY", "1")))
API_RENDER_QUEUE_LIMIT = max(0, int(os.getenv("APP_API_RENDER_QUEUE_LIMIT", "16")))
API_RENDER_QUEUE_TIMEOUT = max(0.0, float(os.getenv("APP_API_RENDER_QUEUE_TIMEOUT", "30")))
...
BADGE_CACHE_TTL = int(os.getenv("BADGE_CACHE_TTL", "21600"))
BADGE_CACHE_SIZE = int(os.getenv("BADGE_CACHE_SIZE", "512"))
BADGE_SNAPSHOT_DIR = os.getenv("BADGE_SNAPSHOT_DIR", "data/badges")
BADGE_SNAPSHOT_TTL_SECONDS = int(os.getenv("BADGE_SNAPSHOT_TTL_SECONDS", str(60 * 24 * 3600)))
BADGE_SNAPSHOT_MAX_COUNT = int(os.getenv("BADGE_SNAPSHOT_MAX_COUNT", "20000"))
